...
function ENT:Draw()
	...
	if money == 0 then moneycolor = AmberPrinter.PrinterColor else moneycolor = Color( 0, 255, 0, 255 ) end
	...
	cam.Start3D2D( Pos + AngTop:Up() * 10.7, AngTop, 0.1 )
		...
		draw.DrawText( AmberPrinter.PrinterName, "FG_JaapokkiRegular_50", -164+308/2+12, -135, Color( 255, 255, 255, 255 ), 1 )
	...
	cam.Start3D2D( Pos + AngBot:Up() * 16.3, AngBot, 0.1 )
		...
		draw.RoundedBox( 0, -75, -92+26*0+2, (140)/10*self:Getlvl_speed(), 20, Color( AmberPrinter.PrinterColor.r, AmberPrinter.PrinterColor.g, AmberPrinter.PrinterColor.b, 150 ) )
		draw.RoundedBox( 0, -75, -92+26*1+2, (140)/10*self:Getlvl_quality(), 20, Color( AmberPrinter.PrinterColor.r, AmberPrinter.PrinterColor.g, AmberPrinter.PrinterColor.b, 150 ) )
		draw.RoundedBox( 0, -75, -92+26*2+2, (140)/10*self:Getlvl_cooler(), 20, Color( AmberPrinter.PrinterColor.r, AmberPrinter.PrinterColor.g, AmberPrinter.PrinterColor.b, 150 ) )
...
local function PrinterMenu()
	...
	Frame:SetTitle( AmberPrinter.FrameTitle .. " - Printer Menu" )
	...
	startButton.DoClick = function()
		if printer:Getdata_power() == 0 then
			...
			net.Start( "fg_printer_" .. AmberPrinter.PrinterID .. "_power" )
	...
	collectButton.DoClick = function()
		if printer:Getdata_money() != 0 then
			...
			net.Start( "fg_printer_" .. AmberPrinter.PrinterID .. "_money" )
				net.WriteEntity( printer )
			net.SendToServer( LocalPlayer() )
	...
	--> Upgrade Price
	if AmberPrinter.PrinterSpeed[ lvl_speed + 1 ] then
		local speedNextP = AmberPrinter.DefaultQuality / 100 * AmberPrinter.PrinterSpeed[ lvl_speed + 1 ][3]
	...
	for i = 1,10 do
		...
		star.Paint = function( pnl, w, h )
			...
			--> Count
			if AmberPrinter.PrinterSpeed[ i ][4] == 1 then
				draw.RoundedBox( 4, 4, 4, w-8, h-8, Color( 155, 89, 182, 150 ) )
			elseif AmberPrinter.PrinterSpeed[ i ][4] == 2 then
	...
	speedUpgrade.DoClick = function()
		...
		net.Start( "fg_printer_" .. AmberPrinter.PrinterID .. "_upgrade_speed" )
			net.WriteEntity( printer )
		net.SendToServer( LocalPlayer() )
		...
		timer.Simple( 0.5, function()
			...
			--> Upgrade Price
			if AmberPrinter.PrinterSpeed[ printer:Getlvl_speed() + 1 ] then
				local speedNextP = AmberPrinter.DefaultQuality / 100 * AmberPrinter.PrinterSpeed[ printer:Getlvl_speed() + 1 ][3]
				speedPrice = "Price: $" .. speedNextP
			else
				speedPrice = "Max Level Reached"
			end
	...
	--> Upgrade Price
	if AmberPrinter.PrinterQuality[ lvl_quality + 1 ] then
		local qualityNextP = AmberPrinter.DefaultQuality / 100 * AmberPrinter.PrinterQuality[ lvl_quality + 1 ][3]
	...
	for i = 1,10 do
		...
		star.Paint = function( pnl, w, h )
			...
			--> Count
			if AmberPrinter.PrinterQuality[ i ][4] == 1 then
				draw.RoundedBox( 4, 4, 4, w-8, h-8, Color( 155, 89, 182, 150 ) )
			elseif AmberPrinter.PrinterQuality[ i ][4] == 2 then
				draw.RoundedBox( 4, 4, 4, w-8, h-8, Color( 231, 76, 60, 150 ) )
			end
	...
	qualityUpgrade.DoClick = function()
		...
		net.Start( "fg_printer_" .. AmberPrinter.PrinterID .. "_upgrade_quality" )
			net.WriteEntity( printer )
		net.SendToServer( LocalPlayer() )
		...
		timer.Simple( 0.5, function()
			...
			--> Upgrade Price
			if AmberPrinter.PrinterQuality[ printer:Getlvl_quality() + 1 ] then
				local qualityNextP = AmberPrinter.DefaultQuality / 100 * AmberPrinter.PrinterQuality[ printer:Getlvl_quality() + 1 ][3]
				qualityPrice = "Price: $" .. qualityNextP
			else
				qualityPrice = "Max Level Reached"
			end
	...
	--> Upgrade Price
	if AmberPrinter.PrinterCooler[ lvl_cooler + 1 ] then
		local coolerNextP = AmberPrinter.DefaultQuality / 100 * AmberPrinter.PrinterCooler[ lvl_cooler + 1 ][3]
	...
	for i = 1,10 do
		...
		star.Paint = function( pnl, w, h )
			...
			--> Count
			if AmberPrinter.PrinterCooler[ i ][4] == 1 then
				draw.RoundedBox( 4, 4, 4, w-8, h-8, Color( 155, 89, 182, 150 ) )
			elseif AmberPrinter.PrinterCooler[ i ][4] == 2 then
				draw.RoundedBox( 4, 4, 4, w-8, h-8, Color( 231, 76, 60, 150 ) )
			end
	...
	coolerUpgrade.DoClick = function()
		...
		net.Start( "fg_printer_" .. AmberPrinter.PrinterID .. "_upgrade_cooler" )
			net.WriteEntity( printer )
		net.SendToServer( LocalPlayer() )
		...
		timer.Simple( 0.5, function()
			...
			--> Upgrade Price
			if AmberPrinter.PrinterCooler[ printer:Getlvl_cooler() + 1 ] then
				local coolerNextP = AmberPrinter.DefaultQuality / 100 * AmberPrinter.PrinterCooler[ printer:Getlvl_cooler() + 1 ][3]
				coolerPrice = "Price: $" .. coolerNextP
			else
				coolerPrice = "Max Level Reached"
			end
...
net.Receive( "fg_printer_" .. AmberPrinter.PrinterID .. "_menu", PrinterMenu )